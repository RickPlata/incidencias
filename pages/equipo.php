      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="./equipoh.php">Historial de reportes de fallas tecnicas</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="./adminh.php">Historial de reportes administrativos</a>
            </li>
          </ul>
        </div>
      </div>
...
<div class="container-fluid" style="margin-top: 100px">
  <table class="table table-success table-striped">
            ...
            <tr>
              ...
              <?php 
              echo "<td> <a href='./delequipo.php?id=".$mostrar['id']."'><input type='button' class='btn btn-danger' value='Completar'></a></td>";
              ?>
            </tr>
            <?php
              }
